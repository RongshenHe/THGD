...
from src.datasets.dataset_utils import expand_graphs, repeat_batch, coarsed_sample_loader, refinement_sample_loader
import os
...
def load_coarsed_model(sample_cfg, cfg):
    ...
    # model.cfg.general.samples_to_save = sample_cfg.save_final
    # model.cfg.general.chains_to_save = sample_cfg.keep_chain
    # model.cfg.general.number_chain_steps = sample_cfg.number_chain_steps
    # model.cfg.general.resample_step = sample_cfg.resample_step
...
def load_refinement_model(sample_cfg, cfg):
    ...
    # model.cfg.general.number_chain_steps = sample_cfg.number_chain_steps
    # model.cfg.general.resample_step = sample_cfg.resample_step
    # model.cfg.general.skip = sample_cfg.skip_t
...
def scaffold_coarsening(scaffold:str, 
    ...
    coarsed_scaffold_data, _ = graph_from_scaffold(scaffold, 
...
def sample(sample_cfg: DictConfig, coarse_cfg: DictConfig, refine_cfg: DictConfig):
    ...
    refinement_scaffold_data = None
    scaffold = sample_cfg.sample.scaffold
    if scaffold is not None:
        scaffold_coarsening(scaffold, 
                        coarsed_dataset_infos,
                        refinement_dataset_infos)
    ...
    refine_loader = refinement_sample_loader(
                                    ...
                                    coarsed_graphs,
                                    refinement_scaffold=refinement_scaffold_data,
                                    )
